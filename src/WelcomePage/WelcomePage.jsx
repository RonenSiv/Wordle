...
export const WelcomePage = ({ pageStyle, enableStart = true }) => {
      ...
      <AnimatePresence mode="wait">
        {!startGame && (
          ...
          >
            ...
            <hr />
            <div className="instructions" style={pageStyle}>
              <h3>How to play:</h3>
              <ul>
                <li>
                  You will be given a word with a length of 5 letters. You will
                  have 6 tries guess the word.
                </li>
                <li>
                ...
                <li>
                  After your submission, the color of the tiles will change as
              ...
              <h3>Scoring:</h3>
              <p>
                You will be given a score based on how many lives you have left
                when you guess the word. The higher your score, the better.
              </p>
              <h3>Leaderboard:</h3>
              <p>
